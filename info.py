...
parser = argparse.ArgumentParser(description='Extract information from ROS2 bag metadata')
parser.add_argument('bag_path', help='Path to input bag')

def extract_info(bag_path):
